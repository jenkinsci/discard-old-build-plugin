...
public class DiscardBuildPublisherTest extends TestCase {
    ...
    private List<FreeStyleBuild> buildListHMS =
            new ArrayList<FreeStyleBuild>(); // buildList used to test specific hold max build feature conditions
    ...
    public void testPerformNoCondition() throws Exception {
        DiscardBuildPublisher publisher = getPublisher(
                new DiscardBuildPublisher("", "", "", "", false, false, false, false, false, "", "", "", true, false));
    ...
    public void testPerformDaysToKeep() throws Exception {
        DiscardBuildPublisher publisher = getPublisher(
                new DiscardBuildPublisher("3", "", "", "", false, false, false, false, false, "", "", "", true, false));
    ...
    public void testPerformNumToKeep() throws Exception {
        DiscardBuildPublisher publisher = getPublisher(
                new DiscardBuildPublisher("", "", "5", "", false, false, false, false, false, "", "", "", true, false));
    ...
    public void testPerformNumAndStatus() throws Exception {
        DiscardBuildPublisher publisher = getPublisher(new DiscardBuildPublisher(
                "", "", "5", "", false, false, true, false, false, // failure
                "", "", "", true, false)); // failure
    ...
    public void testPerformHoldMaxBuildsFirstCnd() throws Exception {
        ...
        DiscardBuildPublisher publisher = getPublisher(new DiscardBuildPublisher(
                "10", "", "20", "", false, false, false, false, false, "", "", "", false, true));
    ...
    public void testPerformHoldMaxBuildsSecondCnd() throws Exception {
        ...
        DiscardBuildPublisher publisher = getPublisher(new DiscardBuildPublisher(
                "10", "", "5", "", false, false, false, false, false, "", "", "", false, true));
    ...
    public void testPerformHoldMaxBuildsThirdCnd() throws Exception {
        ...
        DiscardBuildPublisher publisher = getPublisher(new DiscardBuildPublisher(
                "100000", "", "5", "", false, false, false, false, false, "", "", "", false, true));
    ...
    public void testPerformHoldMaxBuildsFourthCnd() throws Exception {
        ...
        DiscardBuildPublisher publisher = getPublisher(new DiscardBuildPublisher(
                "10", "", "0", "", false, false, false, false, false, "", "", "", false, true));
    ...
    private FreeStyleBuild createBuild(FreeStyleProject project, Result result, String yyyymmdd, boolean building)
            throws Exception {
